...
test.describe('Exams & Report Cards Smoke Tests', () => {
  test('Admin can manage exams', async ({ page }) => {
    ...
    await expect(page.getByText('Exam Management, Results & Report Cards')).toBeVisible();
  ...
  test('Teacher can enter marks', async ({ page }) => {
    ...
    await expect(page.getByText('Exams & Report Cards (Marks Entry)')).toBeVisible();
  ...
  test('Parent can view child results', async ({ page }) => {
    ...
    await expect(page.getByText('Exams, Results & Report Cards')).toBeVisible();
