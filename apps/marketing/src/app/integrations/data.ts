...
export const INTEGRATIONS: IntegrationItem[] = [
  ...
  { name: 'Tally Prime', category: 'Accounting', description: 'CSV export-ready ledger mapping for Indian accounting workflows.', status: 'beta', slug: 'tally' },
  { name: 'Google Workspace', category: 'Identity', description: 'OAuth-based live class scheduling with Calendar + Meet links (tenant setup required).', status: 'beta', slug: 'google-workspace' },
  { name: 'Microsoft 365 Education', category: 'Communication', description: 'OAuth-based live class scheduling with Graph Calendar + Teams meeting links.', status: 'beta', slug: 'teams-meet' },
